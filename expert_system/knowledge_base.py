lugares_turisticos_peru = [
    # Lima (Departamento: Lima)
    {
        "nombre": "Lima",
        "departamento": "Lima",
        "regiones": ["Costa"],
        "climas_ideal": ["Templado", "Húmedo"],
        "preferencias_genericas": {
            "Aventura": ["surf", "parapente"],
            "Cultura": ["colonial", "museo", "historia", "urbano", "arte"],
            "Gastronomia": ["cebiche", "lomo saltado", "aji de gallina", "pisco sour", "fusion"],
            "Naturaleza": ["costa", "parque", "mar"],
            "Presupuesto": ["medio", "lujoso"],
            "Tipo de Compañía": ["solo", "pareja", "familia", "grupo de amigos"],
    ...
    # Cusco (Departamento: Cusco)
    {
        ...
        "departamento": "Cusco",
        "regiones": ["Sierra"],
        "climas_ideal": ["Templado", "Frío", "Seco"],
        "preferencias_genericas": {
            "Aventura": ["trekking", "canotaje", "bicicleta", "escalada"],
            "Cultura": ["inca", "arqueologia", "colonial", "fiesta", "misticismo", "historia", "andino"],
            "Gastronomia": ["cuy", "chiri uchu", "lechon"],
            "Naturaleza": ["montaña", "laguna", "valle", "rio", "paisaje"],
            "Presupuesto": ["medio", "lujoso"],
            "Tipo de Compañía": ["solo", "pareja", "familia", "grupo de amigos"],
    ...
    # Arequipa (Departamento: Arequipa)
    {
        ...
        "climas_ideal": ["Seco", "Soleado"],
        "preferencias_genericas": {
            "Aventura": ["trekking", "canotaje", "escalada", "volcan"],
            "Cultura": ["colonial", "sillar", "monasterio", "historia", "arquitectura"],
            "Gastronomia": ["rocoto relleno", "adobo", "chupe", "queso helado"],
            "Naturaleza": ["cañon", "volcan", "valle", "desierto", "reserva"],
    ...
    # Iquitos (Departamento: Loreto)
    {
        ...
        "departamento": "Loreto",
        "regiones": ["Selva"],
        "climas_ideal": ["Cálido", "Húmedo"],
        "preferencias_genericas": {
            "Aventura": ["expedicion", "pesca", "bote", "kayak"],
            "Cultura": ["comunidad nativa", "mercado", "historia", "amazonia"],
            "Gastronomia": ["juane", "tacacho", "patarashca"],
            "Naturaleza": ["selva", "rio", "amazonas", "biodiversidad", "fauna", "flora", "lago"],
            "Presupuesto": ["medio", "lujoso"],
            "Tipo de Compañía": ["solo", "pareja", "grupo de amigos"],
            "Duración del Viaje": ["semana", "viaje largo"],
            "Accesibilidad": ["media"]
        },
    ...
    # Trujillo (Departamento: La Libertad)
    {
        ...
        "regiones": ["Costa"],
        "climas_ideal": ["Soleado", "Seco"],
        "preferencias_genericas": {
            "Aventura": ["surf", "playa"],
            "Cultura": ["pre-inca", "colonial", "huaca", "chan chan", "marinera", "caballito de totora"],
            "Gastronomia": ["ceviche", "shambar", "sudado"],
            "Naturaleza": ["playa", "mar"],
    ...
    # Puno (Departamento: Puno)
    {
        ...
        "departamento": "Puno",
        "regiones": ["Sierra"],
        "climas_ideal": ["Frío", "Seco"],
        "preferencias_genericas": {
            "Aventura": ["bote", "navegacion"],
            "Cultura": ["andino", "misticismo", "isla", "uro", "taquile", "historia", "folklor", "chullpas"],
            "Gastronomia": ["trucha", "chairo"],
            "Naturaleza": ["lago", "isla", "paisaje"],
            "Presupuesto": ["economico", "medio"],
            "Tipo de Compañía": ["solo", "pareja", "familia", "grupo de amigos"],
            "Duración del Viaje": ["fin de semana", "semana"],
            "Accesibilidad": ["media"]
    ...
    # Nazca (Departamento: Ica)
    {
        ...
        "climas_ideal": ["Soleado", "Seco"],
        "preferencias_genericas": {
            "Aventura": ["sobrevuelo", "sandboarding", "buggie", "desierto"],
            "Cultura": ["lineas", "arqueologia", "historia", "pre-inca", "misterio"],
            "Gastronomia": ["carapulcra", "sopa seca", "pisco"],
            "Naturaleza": ["desierto", "oasis"],
            "Presupuesto": ["medio"],
            "Tipo de Compañía": ["solo", "pareja", "familia", "grupo de amigos"],
            "Duración del Viaje": ["fin de semana", "semana"],
            "Accesibilidad": ["alta"]
    ...
    # Chachapoyas (Departamento: Amazonas)
    {
        ...
        "climas_ideal": ["Templado", "Húmedo"],
        "preferencias_genericas": {
            "Aventura": ["trekking", "senderismo", "catarata", "exploracion"],
            "Cultura": ["pre-inca", "fortaleza", "sarcofago", "historia", "museo"],
            "Gastronomia": ["tacacho", "juane"],
            "Naturaleza": ["selva", "catarata", "cañon", "paisaje"],
            "Presupuesto": ["economico", "medio"],
            "Tipo de Compañía": ["solo", "pareja", "grupo de amigos"],
            "Duración del Viaje": ["semana", "viaje largo"],
            "Accesibilidad": ["media"]
    ...
    # Huaraz (Departamento: Ancash)
    {
        ...
        "climas_ideal": ["Frío", "Seco"],
        "preferencias_genericas": {
            "Aventura": ["montañismo", "trekking", "escalada", "nevado", "andino"],
            "Cultura": ["arqueologia", "historia", "andino"],
            "Gastronomia": ["pachamanca", "cuy picante"],
            "Naturaleza": ["montaña", "laguna", "nevado", "parque nacional", "cordillera"],
            "Presupuesto": ["medio"],
            "Tipo de Compañía": ["solo", "pareja", "grupo de amigos"],
            "Duración del Viaje": ["semana", "viaje largo"],
            "Accesibilidad": ["media"]
    ...
    # Tarapoto (Departamento: San Martín)
    {
        ...
        "climas_ideal": ["Cálido", "Húmedo"],
        "preferencias_genericas": {
            "Aventura": ["canotaje", "rafting", "senderismo"],
            "Cultura": ["comunidad nativa", "artesania", "selva"],
            "Gastronomia": ["juane", "tacacho", "patarashca", "inchicapi"],
            "Naturaleza": ["catarata", "laguna", "rio", "selva", "termales"],
            "Presupuesto": ["economico", "medio"],
            "Tipo de Compañía": ["solo", "pareja", "familia", "grupo de amigos"],
            "Duración del Viaje": ["fin de semana", "semana"],
            "Accesibilidad": ["alta"]
    ...
    # Puerto Maldonado (Departamento: Madre de Dios)
    {
        ...
        "climas_ideal": ["Cálido", "Húmedo"],
        "preferencias_genericas": {
            "Aventura": ["observacion de fauna", "bote", "canopy", "kayak"],
            "Cultura": ["etnobotanica", "comunidad nativa"],
            "Gastronomia": ["pescado", "paiche", "doncella"],
            "Naturaleza": ["selva", "rio", "reserva", "lago", "biodiversidad", "guacamayos"],
            "Presupuesto": ["medio", "lujoso"],
            "Tipo de Compañía": ["solo", "pareja", "grupo de amigos"],
            "Duración del Viaje": ["semana", "viaje largo"],
            "Accesibilidad": ["media"]
    ...
    # Tumbes (Departamento: Tumbes)
    {
        ...
        "departamento": "Tumbes",
        "regiones": ["Costa"],
        "climas_ideal": ["Cálido", "Soleado"],
        "preferencias_genericas": {
            "Aventura": ["kitesurf", "buceo", "surf", "avistamiento"],
            "Cultura": ["manglares", "historia"],
            "Gastronomia": ["conchas negras", "marisco"],
            "Naturaleza": ["playa", "sol", "manglares", "fauna marina"],
            "Presupuesto": ["medio", "lujoso"],
            "Tipo de Compañía": ["solo", "pareja", "familia", "grupo de amigos"],
            "Duración del Viaje": ["fin de semana", "semana"],
            "Accesibilidad": ["alta"]
    ...
    # Ica (Departamento: Ica)
    {
        ...
        "climas_ideal": ["Soleado", "Seco"],
        "preferencias_genericas": {
            "Aventura": ["sandboarding", "tubulares", "sobrevuelo", "desierto"],
            "Cultura": ["pisco", "vino", "arqueologia", "historia", "pre-inca"],
            "Gastronomia": ["carapulcra", "sopa seca", "pisco", "vino"],
            "Naturaleza": ["oasis", "desierto"],
            "Presupuesto": ["economico", "medio"],
            "Tipo de Compañía": ["solo", "pareja", "familia", "grupo de amigos"],
            "Duración del Viaje": ["fin de semana", "semana"],
            "Accesibilidad": ["alta"]
    ...
    # Cajamarca (Departamento: Cajamarca)
    {
        ...
        "climas_ideal": ["Templado", "Húmedo"],
        "preferencias_genericas": {
            "Aventura": ["senderismo", "caballo"],
            "Cultura": ["historia", "colonial", "inca", "carnaval", "feria", "queso"],
            "Gastronomia": ["caldo verde", "cuy frito", "queso"],
            "Naturaleza": ["paisaje", "termales", "cascada"],
            "Presupuesto": ["economico", "medio"],
            "Tipo de Compañía": ["solo", "pareja", "familia", "grupo de amigos"],
            "Duración del Viaje": ["fin de semana", "semana"],
            "Accesibilidad": ["alta"]
    ...
    # Piura (Departamento: Piura)
    {
        ...
        "climas_ideal": ["Cálido", "Soleado"],
        "preferencias_genericas": {
            "Aventura": ["surf", "kitesurf", "buceo", "avistamiento"],
            "Cultura": ["ceramica", "artesania", "historia"],
            "Gastronomia": ["ceviche", "seco de chabelo", "marisco"],
            "Naturaleza": ["playa", "sol", "fauna marina"],
            "Presupuesto": ["medio", "lujoso"],
            "Tipo de Compañía": ["solo", "pareja", "familia", "grupo de amigos"],
            "Duración del Viaje": ["fin de semana", "semana"],
            "Accesibilidad": ["alta"]
    ...
    # Ayacucho (Departamento: Ayacucho)
    {
        ...
        "regiones": ["Sierra"],
        "climas_ideal": ["Templado", "Seco"],
        "preferencias_genericas": {
            "Aventura": ["senderismo", "caminata"],
            "Cultura": ["colonial", "historia", "religioso", "semana santa", "artesania", "piedra de huamanga", "andino"],
            "Gastronomia": ["puca picante", "mondongo", "qapchi"],
            "Naturaleza": ["aguas turquesas", "paisaje", "montaña", "bosque"],
            "Presupuesto": ["economico", "medio"],
            "Tipo de Compañía": ["solo", "pareja", "familia", "grupo de amigos"],
            "Duración del Viaje": ["fin de semana", "semana"],
            "Accesibilidad": ["media"]
    ...
    # Andahuaylas (Departamento: Apurímac)
    {
        ...
        "regiones": ["Sierra"],
        "climas_ideal": ["Frío", "Templado"],
        "preferencias_genericas": {
            "Aventura": ["trekking", "senderismo", "ciclismo"],
            "Cultura": ["andino", "historia", "arqueologia", "ritual", "comunidad", "rural"],
            "Gastronomia": ["cuy chactado", "chicha de jora"],
            "Naturaleza": ["laguna", "bosque de piedras", "catarata", "paisaje", "montaña"],
            "Presupuesto": ["economico", "medio"],
            "Tipo de Compañía": ["solo", "pareja", "grupo de amigos"],
            "Duración del Viaje": ["semana", "viaje largo"],
    ...
    {
        "nombre": "La Mar (Ayacucho)",
        "departamento": "Ayacucho",
        "regiones": ["Sierra", "Selva Alta"],
        "climas_ideal": ["Templado", "Húmedo"],
        "preferencias_genericas": {
            "Aventura": ["senderismo", "trekking extremo", "cañon", "exploracion"],
            "Cultura": ["comunidad", "rural", "autentico", "historia", "andino"],
            "Gastronomia": ["patachi", "puca picante"],
            "Naturaleza": ["catarata", "rio", "selva alta", "paisaje"],
    ...
    {
        "nombre": "Pichari (VRAEM)",
        "departamento": "Cusco",
        "regiones": ["Selva"],
        "climas_ideal": ["Cálido", "Húmedo"],
        "preferencias_genericas": {
            "Aventura": ["canotaje", "senderismo", "exploracion"],
            "Cultura": ["comunidad nativa", "artesania", "agroturismo", "autentico"],
            "Gastronomia": ["juane", "tacacho", "cafe", "cacao"],
            "Naturaleza": ["catarata", "rio", "selva", "plantacion", "paisaje"],
            "Presupuesto": ["medio"],
            "Tipo de Compañía": ["solo", "pareja", "grupo de amigos"],
            "Duración del Viaje": ["semana", "viaje largo"],
    ...
    # Asegúrate de rellenar todas las claves de preferencias_genericas y la descripción_detallada
    # con detalles específicos de cada lugar.
]